...
export const products: Product[] = [
  ...
  },
  {
    ...
    detail:
      "A small lot of Japanese Famicom carts with the artwork still bright. Famicom label printing has held up far better than western equivalents. Includes Akumajou Dracula (the Japanese Castlevania), Pro Wrestling and two Jaleco platformers. Needs a Famicom or an adapter; won't sit in a western NES without one.",
    justIn: "Jul 17",
    stock: 1,
  },
  {
  ...
  },
  {
    ...
    detail:
      "A proper piece of computing history. Powers on to the boot screen and the datasette spins, but we haven't loaded every tape in the pile, so it's sold as seen. Comes with the cassette software shown and a joystick. Heavy enough that it's collection in person only; this one isn't going in a jiffy bag.",
    justIn: "Jul 14",
    stock: 1,
  },
  {
  ...
  },
  {
    ...
    detail:
      "Walnut-cased Minerva with the station dial intact and lit. It's been gone through electrically, with a new mains lead and the perished capacitors replaced, so it can be plugged in without drama. Tunes and sounds like it should.",
    stock: 1,
  },
  {
